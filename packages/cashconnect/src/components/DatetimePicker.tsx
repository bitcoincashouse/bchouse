  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-primary-btn text-primary-btn-foreground hover:bg-primary-btn hover:text-primary-btn-foreground focus:bg-primary-btn focus:text-primary-btn-foreground',
