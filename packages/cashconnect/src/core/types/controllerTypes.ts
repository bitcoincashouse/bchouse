export interface MobileWallet {
  ...
  name: string
  links?: {
    native: string | (() => string) | (() => Promise<string>)
    universal?: string | (() => string) | (() => Promise<string>)
  }
  disableLinkFormatting?: boolean
  image?: string
  networks: WalletNetwork[]
  protocols: WalletProtocol[]
}

export type ProtocolUrls = {
  bchAddress?: string
  bip21?: string
  bip70?: string
  jpp?: string
...
export type WalletProtocol = 'bip70' | 'jpp' | 'jppv2' | 'wc2'
...
export interface ConfigCtrlState {
  ...
  showMobileWalletsOnDesktop?: boolean
  showDesktopWalletsOnMobile?: boolean
  scanMobileWalletOnDesktop?: boolean
}
