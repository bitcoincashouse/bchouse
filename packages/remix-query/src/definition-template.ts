export const definitionTemplate = `declare module "remix-query" {
  import { DefaultError, InfiniteQueryObserverOptions, MutationOptions, QueryClient, QueryObserverOptions, Updater, UseInfiniteQueryResult, UseMutationResult, UseQueryResult } from "@tanstack/react-query";
  ...
  <% routes.forEach(({ route, params, fileName }) => { %>
    "<%- route %>": {
      ...
      actionResult: ActionFunctionResult<typeof import('<%- relativeAppDirPath %>/<%- fileName %>')>
      form: ExportedForm<import('<%- relativeAppDirPath %>/<%- fileName %>').FormSchema>
    };
  <% }) %>
  }
  ...
  type RemixQueryClientUtils = {
     ...
     */
    fetch<Route extends keyof Routes, Params extends Routes[Route]["params"], Result extends Routes[Route]["loaderResult"]>(
      route: Route,
      params: Params,
     ...
     */
    fetchInfinite<Route extends keyof Routes, Params extends Routes[Route]["params"], Result extends Routes[Route]["loaderResult"]>(
      route: Route,
      params: Params,
      opts?: DistributiveOmit<ReactQuery.FetchInfiniteQueryOptions<
        Params,
        Result,
      >, "queryKey">,
    ): Promise<
     ...
     */
    prefetch<Route extends keyof RoutesWithLoader, Params extends RoutesWithLoader[Route]["params"], Result extends RoutesWithLoader[Route]["loaderResult"]>(
      route: Route,
      params: Params,
     ...
     */
    prefetchInfinite<Route extends keyof Routes, Params extends Routes[Route]["params"], Result extends Routes[Route]["loaderResult"]>(
      route: Route,
      params: Params,
      opts?: DistributiveOmit<ReactQuery.FetchInfiniteQueryOptions<
        Params,
     ...
     */
    ensureData<Route extends keyof Routes, Params extends Routes[Route]["params"], Result extends Routes[Route]["loaderResult"]>(
      route: Route,
      params: Params,
      opts?: DistributiveOmit<ReactQuery.FetchQueryOptions<Result>, "queryKey">,
    ): Promise<Result>;
     ...
     */
    invalidate<Route extends keyof Routes, Params extends Routes[Route]["params"], Result extends Routes[Route]["loaderResult"]>(
      route: Route,
     ...
     */
    refetch<Route extends keyof Routes, Params extends Routes[Route]["params"], Result extends Routes[Route]["loaderResult"]>(
      route: Route,
      params?: Partial<Params>,
     ...
     */
    cancel<Route extends keyof Routes, Params extends Routes[Route]["params"], Result extends Routes[Route]["loaderResult"]>(
      route: Route,
      params?: Partial<Params>,
     ...
     */
    reset<Route extends keyof Routes, Params extends Routes[Route]["params"], Result extends Routes[Route]["loaderResult"]>(
      route: Route,
      params?: Partial<Params>,
     ...
     */
    setData<Route extends keyof RoutesWithLoader, Params extends RoutesWithLoader[Route]["params"], Result extends RoutesWithLoader[Route]["loaderResult"]>(
      /**
     ...
     * @link https://tanstack.com/query/v5/docs/reference/QueryClient#queryclientsetquerydata
     */
    setInfiniteData<Route extends keyof RoutesWithCursor, Params extends RoutesWithCursor[Route]["params"], Result extends RoutesWithCursor[Route]["loaderResult"], Cursor extends RoutesWithCursor[Route]["cursor"]>(
      route: Route,
      params: Partial<Params>,
      updater: Updater<
        | ReactQuery.InfiniteData<
            Result,
     ...
     */
    getData<Route extends keyof RoutesWithLoader, Params extends RoutesWithLoader[Route]["params"], Result extends RoutesWithLoader[Route]["loaderResult"]>(
      route: Route,
      params: Params,
    ): Result | undefined;
     ...
     * @link https://tanstack.com/query/v5/docs/reference/QueryClient#queryclientgetquerydata
     */
    getInfiniteData<Route extends keyof RoutesWithCursor, Params extends RoutesWithCursor[Route]["params"], Result extends RoutesWithCursor[Route]["loaderResult"], Cursor extends RoutesWithCursor[Route]["cursor"]>(
      route: Route,
      params: Partial<Params>,
    ):
      | ReactQuery.InfiniteData<
  ...
  type RoutesWithCursor = Pick<
    Routes,
    {
      [K in keyof Routes]: Routes[K]["loader"] extends never ? never : 'cursor' extends keyof Routes[K]["params"] ? K : never
    }[keyof Routes]
  >;
  ...
  type OptionsUnion<BaseOptions, Params, QueryParams> = Params extends Record<string, never> ?
    [opts?: BaseOptions & QueryOptions<QueryParams>] :
    [opts: BaseOptions & QueryOptions<QueryParams> & { params: Params }]

  type ActionOptionsUnion<BaseOptions, Params, QueryParams, Body> = Params extends Record<string, never> ?
  [opts?: BaseOptions & QueryOptions<QueryParams> & { type?: 'json' | 'form' } ] :
  [opts: BaseOptions & QueryOptions<QueryParams> & { type?: 'json' | 'form', params: Params }]
  ...
  >(
    route: Route,
    ...args: ActionOptionsUnion<Omit<RemixMutationOptions, 'mutationKey'>, Params, QueryParams, Form>
  ...
  >(
    ...
    ? [route: Route, query?: Rest["query"], opts?: DistributiveOmit<QueryOptions, 'queryKey'>]
    : [route: Route, params: Rest["params"], query?: Rest["query"], opts?: DistributiveOmit<QueryOptions, 'queryKey'>]
  ...
  export function $useLoaderInfiniteQuery<
    ...
    QueryOptions extends InfiniteQueryObserverOptions<Result, DefaultError, Result, Result, string, PageParam>
  >(
    route: Route,
  ...
  export function $mutate<
    ...
    Result extends RoutesWithAction[Route]["actionResult"]
  >(route: Route, opts: Params extends Record<string, never> ? { body: Body, type?: 'form' | 'json' } : { params: Params, body: Body, type?: 'form' | 'json' }): Promise<Result>
