...
namespace Our.Umbraco.StorageProviders.AWSS3.Imaging
{
  ...
  public class AWSS3FileSystemImageProvider : IImageProvider
  {
    ...
    public AWSS3FileSystemImageProvider(IOptionsMonitor<AWSS3FileSystemOptions> options, IAWSS3FileSystemProvider fileSystemProvider, UmbracoHosting.IHostingEnvironment hostingEnvironment, FormatUtilities formatUtilities, IAmazonS3 s3Client)
    ...
    protected AWSS3FileSystemImageProvider(string name, IOptionsMonitor<AWSS3FileSystemOptions> options, IAWSS3FileSystemProvider fileSystemProvider, UmbracoHosting.IHostingEnvironment hostingEnvironment, FormatUtilities formatUtilities, IAmazonS3 s3Client)
    {
