...
namespace Our.Umbraco.StorageProviders.AWSS3.IO
{
  public class AWSS3FileSystem : IAWSS3FileSystem
  {
    ...
    public AWSS3FileSystem(AWSS3FileSystemOptions options, UmbracoHosting.IHostingEnvironment hostingEnvironment,
    ...
    public string ResolveBucketPath(string? path, bool isDir = false)
    {
      ...
      Console.WriteLine("Path {0}; Prefix {1};", path, _bucketPrefix);
