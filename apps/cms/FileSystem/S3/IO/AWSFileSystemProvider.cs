...
namespace Our.Umbraco.StorageProviders.AWSS3.IO
{
  class AWSS3FileSystemProvider : IAWSS3FileSystemProvider
  {
    ...
    private readonly UmbracoHosting.IHostingEnvironment _hostingEnvironment;
    ...
    public AWSS3FileSystemProvider(IOptionsMonitor<AWSS3FileSystemOptions> optionsMonitor, UmbracoHosting.IHostingEnvironment hostingEnvironment,
