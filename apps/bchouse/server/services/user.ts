          ...
          switch (notification.type) {
            case 'LIKE':
              notificationVm = {
                ...
                user: {
                  ...
                  handle: notification.sourceUser.username,
                  avatarUrl: notification.sourceUser.avatarUrl || '',
                },
            ...
            case 'TIP':
              notificationVm = {
                ...
                tippedAmount: notification.tippedAmount,
                viewed: notification.viewed,
              } as TipNotification
              break
            case 'REPLY':
              ...
              notificationVm = {
                ...
                post:
                  postToViewModel({
                    ...
                    key: 'REPLY:' + notification.sourcePost.id,
                    mediaUrls: [],
                    publishedById: notification.sourceUser.id,
                    replies: [],
                  }) || '',
                viewed: notification.viewed,
              }
