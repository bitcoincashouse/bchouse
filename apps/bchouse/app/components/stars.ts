...
export default function (starsElement: HTMLElement) {
  ...
  function StarChart(this: { div: HTMLElement, pixi: typeof PIXI, renderer: PIXI.CanvasRenderer }, div:HTMLElement, pixi: typeof PIXI) {
    this.div = div;
    this.pixi = pixi;
    ...
    this.renderer = new pixi.CanvasRenderer({
      width: 800, 
      height: 600,
      backgroundColor: new PIXI.Color(),
      backgroundAlpha: 0,
